...
namespace Senai.SviGufo.WebApi.Repositories
{
    public class EventoRepository : IEventoRepository
    {
        ...
        {
            string QueryUpdate = @"UPDATE EVENTOS SET 
                    TITULO = @TITULO, DESCRICAO = @DESCRICAO, 
            DATA_EVENTO = @DATA_EVENTO, ACESSO_LIVRE = @ACESSO_LIVRE, ID_TIPO_EVENTO = @ID_TIPO_EVENTO , ID_INSTITUICAO = @ID_INSTITUICAO WHERE ID = @ID";
